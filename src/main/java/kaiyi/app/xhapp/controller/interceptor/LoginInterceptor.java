...
public class LoginInterceptor extends ManagerController implements HandlerInterceptor {
    ...
    /**后台管理页面访问前缀*/
    private String managerPrifix;
    /**前端页面访问前缀*/
    private String appPrifix;

    public void setManagerPrifix(String managerPrifix) {
        this.managerPrifix = managerPrifix;
    }

    public void setAppPrifix(String appPrifix) {
        this.appPrifix = appPrifix;
    }
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object obj) throws Exception {
        ...
        }else if(requestPrefix.startsWith(appPrifix)){
