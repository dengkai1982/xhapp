...
<main id="main">
    <div class="container">
        <div class="form_container">
            ...
            <div class="detail">
                <div class="detail-title">评论详情<span class="icon icon-caret-down"></span></div>
                <div class="detail-content">
                    <%@include file="/WEB-INF/mgr/access/entityDetail.jsp"%>
                </div>
                <div class="detail-title">评论详情<span class="icon icon-caret-down"></span></div>
                <form id="editor_form" action="${managerPath}/curriculum/courseComment/doReply${suffix}" method="post">
